    ...
    <div class="container-fluid">        
        <div class="row align-items-center">
            ...
            <div class="logo col-md-2 col-lg-2 d-none d-lg-block">
                <a href="/">
                    <img src="{{asset('front/assets/images/logo_thangmobile.png')}}" />
                </a>
            </div>
            <!--End Desktop Logo-->
            <div class="col-2 col-sm-3 col-md-3 col-lg-8">
                ...
                <nav class="grid__item" id="AccessibleNav"><!-- for mobile -->
                    ...
                    <li class="lvl1"><a href="/"><b>Trang chủ</b> <i class="anm anm-angle-down-l"></i></a></li>
                    <li class="lvl1 dropdown"><a href="#"><b>Sản phẩm</b> <i class="anm anm-angle-down-l"></i></a>
                      <ul class="dropdown">
                        @foreach (App\Models\Category::where('status', 1)->get() as $category)
                          <li><a href="/category/{{$category->id}}" class="site-nav">{{ $category->name }}</a></li>
                        @endforeach
                      </ul>
                    </li>
                    <li class="lvl1"><a href="#"><b>Giới thiệu</b> <i class="anm anm-angle-down-l"></i></a></li>
                    <li class="lvl1"><a href="/posts"><b>Tin tức</b> <i class="anm anm-angle-down-l"></i></a></li>
                    <li class="lvl1 "><a href="#"><b>Liên hệ</b> <i class="anm anm-angle-down-l"></i></a>
                    </li>
                  </ul>
                </nav>
                <!--End Desktop Menu-->
            ...
            <div class="col-6 col-sm-6 col-md-6 col-lg-2 d-block d-lg-none mobile-logo">
                <div class="logo">
                    <a href="index.html">
                        <img src="{{asset('front/assets/images/logo_thangmobile.png')}}" alt="Belle Multipurpose Html Template" title="Belle Multipurpose Html Template" />
                    </a>
                </div>
            </div>
            <!--Mobile Logo-->
