            ...
            <div class="col-lg-12">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb bg-primary text-white-all">
                        ...
                        <li class="breadcrumb-item"><a href="#"><i class=""></i> Quản lý slider</a></li>
                        <li class="breadcrumb-item active" aria-current="page"><i class="fas"></i> Danh sách slider</li>
                    </ol>
                </nav>
                <div class="card">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form action="" method="post" id="form_add" action="javascript:void(0)" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        <label>Thứ tự</label> (<span class="text-danger">*</span>)
    ...
    $("body").on("click", ".editRecord", function () {
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                editForm.find("input[name='order']").val(data.data.order);
                editForm.find("input[name='link']").val(data.data.link);
